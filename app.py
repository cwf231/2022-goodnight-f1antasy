...
TEAM_NAMES_LST = [
    'Ham jam and the Gas man',
    'Maximum Wildcard',
    'Billy Deez Nutz',
    'Ph1 Driver: Gergio Vetomacher'
]

leaderboard = (
    f1.results[f1.results['RaceID'] > 202200]
...
pts_per_round = (
    f1.results.loc[f1.results['RaceID'] > 202200]
...
# team_results = (f1.results.loc[f1.results['RaceID'] > 202200]
...
HEADING_DIV = html.Div(id='heading', children=[
	dbc.Row(
		dbc.Col(
			html.H1('F1antasy League - 2022 Season'), 
			width='auto'), 
		justify='center'
		),
	dbc.Row(
